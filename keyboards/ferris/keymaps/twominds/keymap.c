...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT_split_3x5_2(
		...
		_______, SE_EXLM, SE_LBRC, SE_RBRC, SE_QUES,                        _______, _______, _______, _______, _______,
		                           _______, KC_VOLD,                        KC_VOLU, _______
	),
	...
	[7] = LAYOUT_split_3x5_2(
		_______, _______, SE_COLN, KC_ESC,  _______,                        DF(8),   _______, QK_BOOT, _______, KC_DEL,
		_______, SE_PERC, SE_SLSH, KC_ENT,  _______,                        DF(1),   KC_LGUI, _______, _______, _______,
		_______, _______, SE_QUES, SE_EXLM, _______,                        DF(0),   _______, _______, _______, _______,
